...
export const oxford3000c2: Word[] = [
  {
    word: 'conventional',
    type: 'adj.',
    level: 'B2',
  ...
  },
  {
    ...
    meaning: 'kırsal',
    examples: [
      { en: 'Beautiful countryside.' },
      { en: 'Live in the countryside.' }
    ]
  },
  {
    word: 'county',
  ...
  },
  {
    ...
    level: 'B2',
    pronunciation: '/kræk/',
    meaning: 'çatlak, çatlamak',
    examples: [
      { en: 'Crack in the wall.' },
